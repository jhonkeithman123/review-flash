...
const HIGHLIGHTS: FeatureHighlight[] = [
  {
    icon: Sparkles,
    title: "Adaptive Typography & Smooth Internal Scroll",
    badge: "Bug Fix & UX",
    badgeColor: "bg-cyan-500/20 text-cyan-300 border-cyan-500/40",
    desc: "Long questions, comprehensive answers, and code blocks no longer overflow or clip outside card boundaries. Features dynamic font scaling and custom sleek scrolling.",
    href: "/review",
    actionText: "Try Review",
  },
  {
    icon: Layers,
    title: "Physical 3D Card Deal & Switch Physics",
    badge: "Tactile Motion",
    badgeColor: "bg-emerald-500/20 text-emerald-300 border-emerald-500/40",
    desc: "Replaced plain text swapping with physical 3D card dealing, emerald mastery bursts, rose review slides, and spring perspective transitions.",
    href: "/review",
    actionText: "Experience 3D",
  },
  {
    icon: LayoutGrid,
    title: "Grid to List Sideways Morph Animation",
    badge: "Fluid Motion",
    badgeColor: "bg-purple-500/20 text-purple-300 border-purple-500/40",
    desc: "Deck cards now animate dynamically by stretching sideways into full list rows and shrinking horizontally back into grid tiles with cascading staggered delays.",
    href: "/decks",
    actionText: "View Decks",
  },
  {
    icon: ListOrdered,
    title: "Spring Dropdowns & Question Overview Blossom",
    badge: "Motion & UI",
    badgeColor: "bg-indigo-500/20 text-indigo-300 border-indigo-500/40",
    desc: "Glassmorphic spring blossoming for Deck and Set selectors, plus button-origin bloom physics for the Question Overview modal in Test mode.",
    href: "/test",
