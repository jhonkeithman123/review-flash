...
const HIGHLIGHTS: FeatureHighlight[] = [
  {
    icon: Sparkles,
    title: "Hands-On Practical Quest ('Learn by Doing')",
    badge: "Practical Tutoring",
    badgeColor: "bg-cyan-500/20 text-cyan-300 border-cyan-500/40",
    desc: "For learners who hate reading guides: live forced tutoring highlights interactive targets with bright spotlight rings, guiding you through flipping, rating, card creation, and testing with a confetti finale.",
    href: "/decks",
  ...
  },
  {
    ...
    desc: "Fork any shared or read-only deck into your personal library with decoupled card IDs and immediate Owner privileges—allowing full card editing, test customization, and independent deck control.",
    href: "/decks",
    actionText: "View Decks",
  },
  {
    icon: LayoutGrid,
    title: "Responsive Grid vs List View Modes",
    badge: "Deck Studio",
    badgeColor: "bg-indigo-500/20 text-indigo-300 border-indigo-500/40",
    desc: "Switch between spacious 3D grid tiles and an ultra-clean compact horizontal list shelf. Prevents card stretching distortion and saves your preferred view mode automatically.",
    href: "/decks",
    actionText: "Try Layouts",
  },
  {
    icon: Zap,
    title: "Cyberpunk Custom Yes/No Prompts",
    badge: "Design System",
    badgeColor: "bg-teal-500/20 text-teal-300 border-teal-500/40",
    desc: "Replaced unstyled browser alert prompts with sleek glassmorphic confirmation modals featuring smooth spring physics, danger accents, and keyboard ESC / backdrop dismissal.",
    href: "/decks",
    actionText: "Explore",
  },
];
