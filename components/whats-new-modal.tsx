...
const HIGHLIGHTS: FeatureHighlight[] = [
  ...
  {
    icon: Layers,
    title: "Physical 3D Card Deal Animations",
  ...
  {
    icon: ListOrdered,
    title: "Study Deck Set Division (Set A, B, C...)",
    badge: "Deck Studio",
    badgeColor: "bg-indigo-500/20 text-indigo-300 border-indigo-500/40",
    desc: "Easily divide large decks into even sets or size presets (20, 30, 40, 45, 50). Odd remainder cards are automatically merged into the final set.",
    href: "/test",
    actionText: "Take Quiz",
  },
  {
    icon: Zap,
    title: "Multiline Choice Wrapping in Test Mode",
    badge: "Assessment",
    badgeColor: "bg-teal-500/20 text-teal-300 border-teal-500/40",
    desc: "Multiple choice options in Test mode now wrap multi-line text cleanly without truncating or overlapping badges, with staggered cascade entrances.",
    href: "/test",
    actionText: "Try Quiz",
  },
];
